...
/*INSERT INTO `series` (`title`, `rating`, `description`, `has_won_awards`, `seasons`, `country`, `language`) VALUES 
   ...
   insert into films (naam) value ("After"), ("The lion king"), ("Aladdin"), ("Frozen"), ("Madagaskar");
...
INSERT INTO films (naam, volgnummer, duur_minuten, datum_uitkomst, land, omschrijving, id_trailer) VALUE ("After", 1, 105, "11-04-19", 'Duitsland', 'After is een romantische drama film ', 'LlELNgSWMGU' );
INSERT INTO films (naam, volgnummer, duur_minuten, datum_uitkomst, land, omschrijving, id_trailer) VALUE ("The lion king", 2, 118, "9-07-19", 'VS', 'The Lion King is een muzikale fantasyfilm uit 2019, geregisseerd door Jon Favreau en geproduceerd door Walt Disney Pictures. ', '7TavVZMewpY' );
INSERT INTO films (naam, volgnummer, duur_minuten, datum_uitkomst, land, omschrijving, id_trailer) VALUE ("Aladdin", 3, 128, "08-05-19", 'VS', 'Aladdin is een Amerikaanse musicalfilm uit 2019 van Disney. ', 'foyufD52aog' );
INSERT INTO films (naam, volgnummer, duur_minuten, datum_uitkomst, land, omschrijving, id_trailer) VALUE ("Frozen", 4, 109, "11-12-13", 'VS', 'Frozen is een Amerikaanse animatiefilm. ', 'TbQm5doF_Uc' );
INSERT INTO films (naam, volgnummer, duur_minuten, datum_uitkomst, land, omschrijving, id_trailer) VALUE ("Madagaskar", 5, 86, "15-06-05", 'VS', 'Madagascar is een computeranimatiefilm van DreamWorks Animation.', 'fq5zU9T_Hl4' );
SELECT * FROM films;
